...
def ipinfo():
       ...
       print (" ")
       slowprint("\033[1;36m =====================================")
       slowprint("\033[1;33m|        By Chaitanya Shedge          |")
       slowprint("\033[1;36m =====================================")
       slowprint("\033[1;91m|  https://hackers-outpost.blogspot.com/ |")
       slowprint("\033[1;36m =====================================")
       print (" ")
...
def about():
       ...
       slowprint ("\033[1;33m" + "         [+] Autor         =>\033[1;36m" + " Chaitanya Shedge")
       slowprint ("\033[1;33m" + "         [+] Latest Update =>\033[1;36m" + " 17/3/2023")
       slowprint ("\033[1;33m" + "         [+] Github        =>\033[1;36m" + " HackersOutpost")
       slowprint ("\033[1;91m -----------------------------------------------")
       slowprint ("\033[1;95m" + "[+] https://hackers-outpost.blogspot.com/ [+]")
       slowprint ("\033[1;91m -----------------------------------------------")
